...
func (b *Benchmark) loadProgram() {
	...
	b.hsaco = insts.LoadKernelCodeObjectFromBytes(
		hsacoBytes, "blackscholes_kernel")
	if b.hsaco == nil {
...
func (b *Benchmark) initMem() {
	...
	if b.useManagedMemory { // sbin_claude
		b.gS = b.driver.AllocateManaged(b.context, bytes)
		b.gK = b.driver.AllocateManaged(b.context, bytes)
		b.gT = b.driver.AllocateManaged(b.context, bytes)
		b.gSigma = b.driver.AllocateManaged(b.context, bytes)
		b.gCall = b.driver.AllocateManaged(b.context, bytes)
		b.gPut = b.driver.AllocateManaged(b.context, bytes)
	...
	b.driver.MemCopyH2D(b.context, b.gS, b.hS)         // sbin_claude
	b.driver.MemCopyH2D(b.context, b.gK, b.hK)         // sbin_claude
	b.driver.MemCopyH2D(b.context, b.gT, b.hT)         // sbin_claude
	b.driver.MemCopyH2D(b.context, b.gSigma, b.hSigma) // sbin_claude
}
