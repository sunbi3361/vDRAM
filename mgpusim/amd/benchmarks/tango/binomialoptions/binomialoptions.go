...
func (b *Benchmark) initMem() {
	...
	if b.useManagedMemory { // sbin_claude
		b.gOptions = b.driver.AllocateManaged(b.context, optBytes)
		b.gPrices = b.driver.AllocateManaged(b.context, priceBytes)
	...
	b.driver.MemCopyH2D(b.context, b.gOptions, b.options) // sbin_claude
}
