...
func (b *Benchmark) initMem() {
	...
	if b.useManagedMemory { // sbin_claude
		b.gA = b.driver.AllocateManaged(b.context, uint64(n*4))
		b.gB = b.driver.AllocateManaged(b.context, uint64(n*4))
		b.gC = b.driver.AllocateManaged(b.context, uint64(n*4))
