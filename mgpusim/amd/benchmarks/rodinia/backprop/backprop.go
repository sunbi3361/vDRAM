...
func (b *Benchmark) loadProgram() {
	...
	load := func(name string) *insts.KernelCodeObject {
		k := insts.LoadKernelCodeObjectFromBytes(hsacoBytes, name)
		if k == nil {
...
func (b *Benchmark) initMem() { //nolint:funlen,gocognit
	...
	alloc := func(n int) driver.Ptr {
		if b.useManagedMemory { // sbin_claude
			return b.driver.AllocateManaged(b.context, uint64(n*4))
	...
	b.driver.MemCopyH2D(b.context, b.gInput, b.hInput)   // sbin_claude
	b.driver.MemCopyH2D(b.context, b.gW1, b.hW1)         // sbin_claude
	b.driver.MemCopyH2D(b.context, b.gB1, b.hB1)         // sbin_claude
	b.driver.MemCopyH2D(b.context, b.gW2, b.hW2)         // sbin_claude
	b.driver.MemCopyH2D(b.context, b.gB2, b.hB2)         // sbin_claude
	b.driver.MemCopyH2D(b.context, b.gTarget, b.hTarget) // sbin_claude
}
