...
func (b *Benchmark) initMem() {
	...
	if b.useManagedMemory { // sbin_claude
		b.gWall = b.driver.AllocateManaged(b.context, wallBytes)
		b.gBuf[0] = b.driver.AllocateManaged(b.context, rowBytes)
		b.gBuf[1] = b.driver.AllocateManaged(b.context, rowBytes)
	...
	b.driver.MemCopyH2D(b.context, b.gWall, b.wall) // sbin_claude

	// Initialize src buffer (gBuf[0]) with row 0 of the wall.
	row0 := make([]int32, cols)
	copy(row0, b.wall[:cols])
	b.driver.MemCopyH2D(b.context, b.gBuf[0], row0) // sbin_claude
}
