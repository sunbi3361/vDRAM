...
func (b *Benchmark) initMem() {
	...
	if b.useManagedMemory { // sbin_claude
		b.gTempA = b.driver.AllocateManaged(b.context, uint64(total*4))
		b.gTempB = b.driver.AllocateManaged(b.context, uint64(total*4))
		b.gPower = b.driver.AllocateManaged(b.context, uint64(total*4))
	...
	b.driver.MemCopyH2D(b.context, b.gTempA, b.temp)  // sbin_claude
	b.driver.MemCopyH2D(b.context, b.gPower, b.power) // sbin_claude
}
