...
func (b *Benchmark) initMem() {
	...
	if b.useManagedMemory { // sbin_claude
		b.gA = b.driver.AllocateManaged(b.context, bytesA)
		b.gB = b.driver.AllocateManaged(b.context, bytesB)
		b.gM = b.driver.AllocateManaged(b.context, bytesA)
	...
	b.driver.MemCopyH2D(b.context, b.gB, b.bInit) // sbin_claude

	// Zero-initialize the multiplier matrix.
	mZero := make([]float32, n*n)
	b.driver.MemCopyH2D(b.context, b.gM, mZero) // sbin_claude
}
