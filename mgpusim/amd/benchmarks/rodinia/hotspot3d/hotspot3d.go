...
func (b *Benchmark) initMem() {
	...
	if b.useManagedMemory { // sbin_claude
		b.gTemp[0] = b.driver.AllocateManaged(b.context, bytes)
		b.gTemp[1] = b.driver.AllocateManaged(b.context, bytes)
		b.gPower = b.driver.AllocateManaged(b.context, bytes)
	...
	b.driver.MemCopyH2D(b.context, b.gTemp[0], b.tempInit) // sbin_claude
