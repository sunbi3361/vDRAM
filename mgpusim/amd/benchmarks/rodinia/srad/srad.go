...
func (b *Benchmark) loadProgram() {
	...
	b.hsaco1 = insts.LoadKernelCodeObjectFromBytes(hsacoBytes, "srad1")
	if b.hsaco1 == nil {
		log.Panic("Failed to load srad1 kernel binary")
	}
	b.hsaco2 = insts.LoadKernelCodeObjectFromBytes(hsacoBytes, "srad2")
	if b.hsaco2 == nil {
...
func (b *Benchmark) initMem() {
	...
	if b.useManagedMemory { // sbin_claude
		b.gJ = b.driver.AllocateManaged(b.context, uint64(total*4))
		b.gDN = b.driver.AllocateManaged(b.context, uint64(total*4))
		b.gDS = b.driver.AllocateManaged(b.context, uint64(total*4))
		b.gDW = b.driver.AllocateManaged(b.context, uint64(total*4))
		b.gDE = b.driver.AllocateManaged(b.context, uint64(total*4))
		b.gC = b.driver.AllocateManaged(b.context, uint64(total*4))
	...
	b.driver.MemCopyH2D(b.context, b.gJ, b.jInit) // sbin_claude
}
