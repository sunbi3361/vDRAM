...
func (b *Benchmark) initMem() {
	...
	if b.useManagedMemory { // sbin_claude
		b.gA = b.driver.AllocateManaged(b.context, uint64(total*4))
		b.gB = b.driver.AllocateManaged(b.context, uint64(total*4))
	...
	b.driver.MemCopyH2D(b.context, b.gA, b.hData) // sbin_claude
	b.driver.MemCopyH2D(b.context, b.gB, b.hData) // sbin_claude
}
