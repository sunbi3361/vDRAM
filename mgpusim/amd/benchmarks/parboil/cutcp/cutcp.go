...
// sarchlab/gpu_benchmarks (tier2/parboil_cutcp) for the MGPUSim MI300X
// (CDNA3 / gfx942) model.
//
...
func (b *Benchmark) initMem() {
	...
	if b.useManagedMemory { // sbin_claude
		b.gAtoms = b.driver.AllocateManaged(
			b.context, uint64(b.NumAtoms*4*4))
		b.gPot = b.driver.AllocateManaged(
	...
	b.driver.MemCopyH2D(b.context, b.gAtoms, b.atoms) // sbin_claude
}
