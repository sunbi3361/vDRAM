...
// sarchlab/gpu_benchmarks (tier2/altis_cfd) for the MGPUSim MI300X
// (CDNA3 / gfx942) model.
//
...
func (b *Benchmark) loadProgram() {
	...
	b.hsaco = insts.LoadKernelCodeObjectFromBytes(
		hsacoBytes, "compute_flux_kernel")
	if b.hsaco == nil {
...
func (b *Benchmark) initMem() { //nolint:funlen,gocognit
	...
	if b.useManagedMemory { // sbin_claude
		alloc = b.driver.AllocateManaged
	...
	b.driver.MemCopyH2D(b.context, b.gRho, b.hRho)             // sbin_claude
	b.driver.MemCopyH2D(b.context, b.gMx, b.hMx)               // sbin_claude
	b.driver.MemCopyH2D(b.context, b.gMy, b.hMy)               // sbin_claude
	b.driver.MemCopyH2D(b.context, b.gMz, b.hMz)               // sbin_claude
	b.driver.MemCopyH2D(b.context, b.gEnergy, b.hEnergy)       // sbin_claude
	b.driver.MemCopyH2D(b.context, b.gNeighbors, b.hNeighbors) // sbin_claude
	b.driver.MemCopyH2D(b.context, b.gNormals, b.hNormals)     // sbin_claude
	b.driver.MemCopyH2D(b.context, b.gAreas, b.hAreas)         // sbin_claude
}
...
func (b *Benchmark) Verify() {
	...
	for i := 0; i < n; i++ {
		...
		if i < 16 {
			log.Printf("DBG cell %d rho ref=%.9f got=%.9f\n", i, ref[0], got[0])
		}
