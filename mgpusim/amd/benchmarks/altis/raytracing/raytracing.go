...
func (b *Benchmark) initMem() {
	...
	if b.useManagedMemory { // sbin_claude
		b.gImage = b.driver.AllocateManaged(b.context, imageBytes)
		b.gSpheres = b.driver.AllocateManaged(b.context, sphereBytes)
	...
	b.driver.MemCopyH2D(b.context, b.gSpheres, b.spheres) // sbin_claude
}
