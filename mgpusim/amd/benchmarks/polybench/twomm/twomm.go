...
func (b *Benchmark) initMem() {
	...
	if b.useManagedMemory { // sbin_claude
		b.gA = b.driver.AllocateManaged(b.context, uint64(numElem*4))
		b.gB = b.driver.AllocateManaged(b.context, uint64(numElem*4))
		b.gC = b.driver.AllocateManaged(b.context, uint64(numElem*4))
		b.gD = b.driver.AllocateManaged(b.context, uint64(numElem*4))
		b.gE = b.driver.AllocateManaged(b.context, uint64(numElem*4))
	...
	b.driver.MemCopyH2D(b.context, b.gA, b.a)     // sbin_claude
	b.driver.MemCopyH2D(b.context, b.gB, b.b)     // sbin_claude
	b.driver.MemCopyH2D(b.context, b.gC, b.c)     // sbin_claude
	b.driver.MemCopyH2D(b.context, b.gD, b.dInit) // sbin_claude
	b.driver.MemCopyH2D(b.context, b.gE, b.eInit) // sbin_claude
}
