...
func (b *Benchmark) loadProgram() {
	...
	b.hsaco = insts.LoadKernelCodeObjectFromBytes(
		hsacoBytes, "polybench_syr2k_kernel")
	if b.hsaco == nil {
...
func (b *Benchmark) initMem() {
	...
	if b.useManagedMemory { // sbin_claude
		b.gA = b.driver.AllocateManaged(b.context, uint64(n*m*4))
		b.gB = b.driver.AllocateManaged(b.context, uint64(n*m*4))
		b.gC = b.driver.AllocateManaged(b.context, uint64(n*n*4))
