...
func (b *Benchmark) initMem() {
	...
	if b.useManagedMemory { // sbin_claude
		b.gEx = b.driver.AllocateManaged(b.context, uint64(numElem*4))
		b.gEy = b.driver.AllocateManaged(b.context, uint64(numElem*4))
		b.gHz = b.driver.AllocateManaged(b.context, uint64(numElem*4))
	...
	b.driver.MemCopyH2D(b.context, b.gEx, b.exInit) // sbin_claude
	b.driver.MemCopyH2D(b.context, b.gEy, b.eyInit) // sbin_claude
	b.driver.MemCopyH2D(b.context, b.gHz, b.hzInit) // sbin_claude
}
