...
func (b *Benchmark) initMem() {
	...
	if b.useManagedMemory { // sbin_claude
		b.gData = b.driver.AllocateManaged(b.context, uint64(numElem*4))
		b.gMean = b.driver.AllocateManaged(b.context, uint64(n*4))
		b.gStddev = b.driver.AllocateManaged(b.context, uint64(n*4))
		b.gCorr = b.driver.AllocateManaged(b.context, uint64(numElem*4))
	...
	b.driver.MemCopyH2D(b.context, b.gData, b.data) // sbin_claude
}
