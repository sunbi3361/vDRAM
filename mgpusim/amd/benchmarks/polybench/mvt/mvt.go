...
func (b *Benchmark) initMem() {
	...
	if b.useManagedMemory { // sbin_claude
		...
		b.gY1 = b.driver.AllocateManaged(b.context, uint64(n*4))
		b.gY2 = b.driver.AllocateManaged(b.context, uint64(n*4))
		b.gX1 = b.driver.AllocateManaged(b.context, uint64(n*4))
		b.gX2 = b.driver.AllocateManaged(b.context, uint64(n*4))
	...
	b.driver.MemCopyH2D(b.context, b.gY1, b.y1) // sbin_claude
	b.driver.MemCopyH2D(b.context, b.gY2, b.y2) // sbin_claude
}
