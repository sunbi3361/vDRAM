...
func (b *Benchmark) initMem() {
	...
	if b.useManagedMemory { // sbin_claude
		b.gInput = b.driver.AllocateManaged(
			b.context, uint64(volElems*4))
		b.gFilter = b.driver.AllocateManaged(
			b.context, uint64(filtElems*4))
		b.gOutput = b.driver.AllocateManaged(
			b.context, uint64(volElems*4))
	...
	b.driver.MemCopyH2D(b.context, b.gInput, b.input)   // sbin_claude
	b.driver.MemCopyH2D(b.context, b.gFilter, b.filter) // sbin_claude
}
