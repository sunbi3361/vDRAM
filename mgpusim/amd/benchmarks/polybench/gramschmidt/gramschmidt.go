...
func (b *Benchmark) initMem() {
	...
	if b.useManagedMemory { // sbin_claude
		b.gA = b.driver.AllocateManaged(b.context, uint64(m*n*4))
		b.gQ = b.driver.AllocateManaged(b.context, uint64(m*n*4))
		b.gR = b.driver.AllocateManaged(b.context, uint64(n*n*4))
		b.gNrm = b.driver.AllocateManaged(b.context, uint64(4))
	...
	b.driver.MemCopyH2D(b.context, b.gA, b.aInit) // sbin_claude
	zeroQ := make([]float32, m*n)
	zeroR := make([]float32, n*n)
	b.driver.MemCopyH2D(b.context, b.gQ, zeroQ) // sbin_claude
	b.driver.MemCopyH2D(b.context, b.gR, zeroR) // sbin_claude
}
