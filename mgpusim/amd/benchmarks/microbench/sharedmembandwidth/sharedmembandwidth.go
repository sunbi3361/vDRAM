...
func (b *Benchmark) initMem() {
	...
	if b.useManagedMemory { // sbin_claude
		b.gIn = b.driver.AllocateManaged(
			b.context, uint64(inFloats*4))
		b.gSink = b.driver.AllocateManaged(
	...
	b.driver.MemCopyH2D(b.context, b.gIn, in) // sbin_claude

	// Zero-initialise the sink so unwritten lanes are well defined.
	zeros := make([]float32, b.NumBlocks)
	b.driver.MemCopyH2D(b.context, b.gSink, zeros) // sbin_claude
}
