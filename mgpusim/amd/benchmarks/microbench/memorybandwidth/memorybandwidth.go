...
func (b *Benchmark) initMem() {
	...
	if b.useManagedMemory { // sbin_claude
		b.gSrc = b.driver.AllocateManaged(b.context, uint64(n*4))
		b.gDst = b.driver.AllocateManaged(b.context, uint64(n*4))
	...
	b.driver.MemCopyH2D(b.context, b.gSrc, b.src) // sbin_claude
}
