...
func (b *Benchmark) initMem() {
	...
	if b.useManagedMemory { // sbin_claude
		b.gIn = b.driver.AllocateManaged(b.context, inBytes)
		b.gOut = b.driver.AllocateManaged(b.context, outBytes)
	...
	b.driver.MemCopyH2D(b.context, b.gIn, b.in) // sbin_claude
	// Initialize the output to zero so a missing store is detectable.
	b.driver.MemCopyH2D(b.context, b.gOut, make([]float64, b.numThreads)) // sbin_claude
}
