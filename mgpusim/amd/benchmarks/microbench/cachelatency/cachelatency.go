...
func (b *Benchmark) initMem() {
	...
	if b.useManagedMemory { // sbin_claude
		b.gArr = b.driver.AllocateManaged(
			b.context, uint64(b.n*4))
		b.gResult = b.driver.AllocateManaged(
			b.context, uint64(4))
	...
	b.driver.MemCopyH2D(b.context, b.gArr, b.chain) // sbin_claude
	...
	b.driver.MemCopyH2D(b.context, b.gResult, []uint32{0}) // sbin_claude
}
